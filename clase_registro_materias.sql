...
CREATE TABLE `registro_materias` (
  ...
  CONSTRAINT `registro_materias_ibfk_1` FOREIGN KEY (`EST_ID`) REFERENCES `estudiantes` (`EST_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `registro_materias_ibfk_2` FOREIGN KEY (`MAT_ID`) REFERENCES `materias` (`MAT_ID`) ON DELETE CASCADE ON UPDATE CASCADE
